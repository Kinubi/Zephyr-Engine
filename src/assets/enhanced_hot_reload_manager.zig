...
pub const EnhancedHotReloadManager = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, asset_manager: *EnhancedAssetManager) !Self {
        var manager = Self{
            .allocator = allocator,
...
var global_hot_reload_manager: ?*EnhancedHotReloadManager = null;

pub fn setGlobalHotReloadManager(manager: *EnhancedHotReloadManager) void {
