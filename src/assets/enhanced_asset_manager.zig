...
const enhanced_asset_loader = @import("enhanced_asset_loader.zig");
const enhanced_hot_reload_manager = @import("enhanced_hot_reload_manager.zig");
...
pub const EnhancedAssetLoader = enhanced_asset_loader.EnhancedAssetLoader;
...
pub const FallbackAssets = struct {
    ...
    pub fn init(asset_manager: *EnhancedAssetManager) !FallbackAssets {
...
pub const EnhancedAssetManager = struct {
    // Core components
    registry: *AssetRegistry,
    loader: *EnhancedAssetLoader = undefined,
    ...
    hot_reload_manager: ?enhanced_hot_reload_manager.EnhancedHotReloadManager = null,
    ...
    pub fn init(allocator: std.mem.Allocator, graphics_context: *GraphicsContext, thread_pool: *EnhancedThreadPool) !*Self {
        ...
        const loader = try allocator.create(EnhancedAssetLoader);
        loader.* = try EnhancedAssetLoader.init(allocator, registry, graphics_context, thread_pool, self);
        self.loader = loader;
    ...
    pub fn initHotReload(self: *Self) !void {
        self.hot_reload_manager = try enhanced_hot_reload_manager.EnhancedHotReloadManager.init(self.allocator, self);
