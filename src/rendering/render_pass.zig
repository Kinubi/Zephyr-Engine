...
pub const VulkanRenderPassResources = struct {
    ...
    pub fn init(
        ...
        // Create render pass
        self.render_pass = try graphics_context.vkd.createRenderPass(
        ...
        self.framebuffers[0] = try graphics_context.vkd.createFramebuffer(
            graphics_context.dev,
...
pub const RenderContext = struct {
    ...
    pub fn beginVulkanRenderPass(
        ...
        self.graphics_context.vkd.cmdBeginRenderPass(
            self.command_buffer, 
            &render_pass_info, 
            .@"inline"
        );
