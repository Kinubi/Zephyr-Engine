...
pub const AssetRegistry = struct {
    ...
    pub fn registerAsset(self: *AssetRegistry, path: []const u8, asset_type: AssetType) !AssetId {
        self.mutex.lock();
    ...
    pub fn getAsset(self: *AssetRegistry, asset_id: AssetId) ?*AssetMetadata {
        self.mutex.lock();
        defer self.mutex.unlock();
    ...
    pub fn getAssetByPath(self: *AssetRegistry, path: []const u8) ?*AssetMetadata {
    ...
    pub fn getAssetId(self: *AssetRegistry, path: []const u8) ?AssetId {
        return self.path_to_id.get(path);
    }

    /// Add dependency relationship between assets
    pub fn addDependency(self: *AssetRegistry, asset_id: AssetId, dependency_id: AssetId) !void {
    ...
    pub fn removeDependency(self: *AssetRegistry, asset_id: AssetId, dependency_id: AssetId) void {
    ...
    pub fn incrementRef(self: *AssetRegistry, asset_id: AssetId) void {
        if (self.getAsset(asset_id)) |asset| {
            asset.incrementRef();
        }
    }
    ...
    pub fn decrementRef(self: *AssetRegistry, asset_id: AssetId) bool {
        if (self.getAsset(asset_id)) |asset| {
    ...
    pub fn markAsLoaded(self: *AssetRegistry, asset_id: AssetId, file_size: u64) void {
        if (self.getAsset(asset_id)) |asset| {
    ...
    pub fn markAsFailed(self: *AssetRegistry, asset_id: AssetId, error_msg: []const u8) void {
    ...
    pub fn forceMarkUnloaded(self: *AssetRegistry, asset_id: AssetId) void {
        self.mutex.lock();
        defer self.mutex.unlock();
    ...
    pub fn markAsLoading(self: *AssetRegistry, asset_id: AssetId) void {
        if (self.getAsset(asset_id)) |asset| {
            asset.state = .loading;
        }
    }
    ...
    pub fn markAsLoadingAtomic(self: *AssetRegistry, asset_id: AssetId) bool {
        self.mutex.lock();
        defer self.mutex.unlock();
    ...
    pub fn markAsStaged(self: *AssetRegistry, asset_id: AssetId, file_size: u64) void {
        if (self.getAsset(asset_id)) |asset| {
            asset.state = .staged;
            asset.file_size = file_size;
        }
    ...
    pub fn getAssetsByType(self: *AssetRegistry, asset_type: AssetType, allocator: std.mem.Allocator) ![]AssetId {
    ...
    pub fn getUnloadableAssets(self: *AssetRegistry, allocator: std.mem.Allocator) ![]AssetId {
        var result = std.ArrayList(AssetId){};
    ...
    pub fn getDependencyChain(self: *AssetRegistry, asset_id: AssetId, allocator: std.mem.Allocator) ![]AssetId {
    ...
    fn collectDependencies(self: *AssetRegistry, asset_id: AssetId, visited: *std.AutoHashMap(AssetId, void), result: *std.ArrayList(AssetId), allocator: std.mem.Allocator) !void {
        // Avoid cycles
    ...
    pub fn getStatistics(self: *AssetRegistry) AssetStatistics {
